  ...
  return (
    <AppShell>
      <div className="space-y-6 pb-8">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold">Autonomous Patch & IaC Generator</h1>
            <p className="text-sm text-gray-500 mt-1">Auto-generate secure infrastructure</p>
          </div>
          <motion.button 
        ...
        >
          ...
          <p className="text-sm text-gray-500 max-w-md">
            The <strong>Autonomous Patch & IaC Generator</strong> is currently being scaffolded. 
