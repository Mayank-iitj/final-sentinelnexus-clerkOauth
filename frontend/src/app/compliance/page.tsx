  ...
  return (
    <AppShell>
      <div className="space-y-6 pb-8">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold">Multi-Framework Compliance</h1>
            <p className="text-sm text-gray-500 mt-1">One-Click Compliance Automation & Evidence Collection</p>
          </div>
          <motion.button 
        ...
        >
          ...
          <p className="text-sm text-gray-500 max-w-md">
            The <strong>Multi-Framework Compliance</strong> is currently being scaffolded. 
