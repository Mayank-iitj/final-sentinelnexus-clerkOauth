  ...
  return (
    <AppShell>
      <div className="space-y-6 pb-8">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold">AI Compliance Chat Assistant</h1>
            <p className="text-sm text-gray-500 mt-1">Chat with your compliance posture</p>
          </div>
          <motion.button 
        ...
        >
          ...
          <p className="text-sm text-gray-500 max-w-md">
            The <strong>AI Compliance Chat Assistant</strong> is currently being scaffolded. 
