      ...
      <div className="space-y-6 pb-8">
        ...
        <motion.div variants={stagger} initial="hidden" animate="show" className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <motion.div variants={fadeUp} className="nub-card rounded-2xl p-5 border border-white/[0.04] bg-white/[0.01]">
            ...
            <div className="text-3xl font-bold tracking-tight text-white mt-1">2</div>
          </motion.div>
          <motion.div variants={fadeUp} className="nub-card rounded-2xl p-5 border border-white/[0.04] bg-white/[0.01]">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-sm">
                <tr className="hover:bg-white/[0.02] transition-colors">
                  <td className="py-3 border-b border-white/[0.02]">RedTeam-Alpha</td>
                  <td className="py-3 border-b border-white/[0.02]">Offensive AI</td>
                  <td className="py-3 border-b border-white/[0.02]">Running</td>
                  <td className="py-3 border-b border-white/[0.02]">12%</td>
                </tr>
                <tr className="hover:bg-white/[0.02] transition-colors">
                  <td className="py-3 border-b border-white/[0.02]">Log-Analyzer-v2</td>
                  <td className="py-3 border-b border-white/[0.02]">Defensive AI</td>
                  <td className="py-3 border-b border-white/[0.02]">Running</td>
                  <td className="py-3 border-b border-white/[0.02]">4%</td>
                </tr>
              </tbody>
            </table>
          </div>
