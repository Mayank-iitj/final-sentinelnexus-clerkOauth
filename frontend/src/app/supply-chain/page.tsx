  ...
  return (
    <AppShell>
      <div className="space-y-6 pb-8">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold">Continuous Supply Chain Intelligence</h1>
            <p className="text-sm text-gray-500 mt-1">AI Vendor Risk Rating</p>
          </div>
          <motion.button 
        ...
        >
          ...
          <p className="text-sm text-gray-500 max-w-md">
            The <strong>Continuous Supply Chain Intelligence</strong> is currently being scaffolded. 
