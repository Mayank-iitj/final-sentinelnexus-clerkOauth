  ...
  return (
    <AppShell>
      <div className="space-y-6 pb-8">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold">Real-Time Organizational Digital Twin</h1>
            <p className="text-sm text-gray-500 mt-1">Simulate attacks on your corporate twin</p>
          </div>
          <motion.button 
        ...
        >
          ...
          <p className="text-sm text-gray-500 max-w-md">
            The <strong>Real-Time Organizational Digital Twin</strong> is currently being scaffolded. 
