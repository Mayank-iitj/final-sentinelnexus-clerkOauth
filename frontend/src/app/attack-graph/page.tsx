  ...
  return (
    <AppShell>
      <div className="space-y-6 pb-8">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold">Interactive Live Attack Graph</h1>
            <p className="text-sm text-gray-500 mt-1">Visualize lateral movement paths</p>
          </div>
          <motion.button 
        ...
        >
          ...
          <p className="text-sm text-gray-500 max-w-md">
            The <strong>Interactive Live Attack Graph</strong> is currently being scaffolded. 
