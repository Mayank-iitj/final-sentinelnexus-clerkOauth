  ...
  return (
    <AppShell>
      <div className="space-y-6 pb-8">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold">Cyber Insurance Readiness Assessment</h1>
            <p className="text-sm text-gray-500 mt-1">Quantify risk for insurers</p>
          </div>
          <motion.button 
        ...
        >
          ...
          <p className="text-sm text-gray-500 max-w-md">
            The <strong>Cyber Insurance Readiness Assessment</strong> is currently being scaffolded. 
