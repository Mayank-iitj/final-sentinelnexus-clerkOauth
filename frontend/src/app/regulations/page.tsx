  ...
  return (
    <AppShell>
      <div className="space-y-6 pb-8">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold">Global Regulation Intelligence Engine</h1>
            <p className="text-sm text-gray-500 mt-1">Track AI acts and compliance laws globally</p>
          </div>
          <motion.button 
        ...
        >
          ...
          <p className="text-sm text-gray-500 max-w-md">
            The <strong>Global Regulation Intelligence Engine</strong> is currently being scaffolded. 
