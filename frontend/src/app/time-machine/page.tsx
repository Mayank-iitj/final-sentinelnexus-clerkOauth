  ...
  return (
    <AppShell>
      <div className="space-y-6 pb-8">
        ...
        >
          <div>
            <h1 className="text-2xl font-bold">Security Time Machine</h1>
            <p className="text-sm text-gray-500 mt-1">Replay incidents and rollback states</p>
          </div>
          <motion.button 
        ...
        >
          ...
          <p className="text-sm text-gray-500 max-w-md">
            The <strong>Security Time Machine</strong> is currently being scaffolded. 
