...
const posts = [
  { title: "From Prototype to Production: Wiring up the OpenRouter API for Live Red Teaming", date: "2026-08-11", category: "Engineering", excerpt: "How we stripped out mock states and wired our autonomous agents to live OpenRouter LLM streams in under a day, bringing 10x speeds to our Red Team and Blue Team simulations.", readTime: "5 min" },
