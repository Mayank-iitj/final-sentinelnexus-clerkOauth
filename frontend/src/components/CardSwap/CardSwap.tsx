...
export const Card = forwardRef<HTMLDivElement, CardProps>(
  ({ customClass, className, ...rest }, ref: ForwardedRef<HTMLDivElement>) => (
    <div
      ref={ref}
      {...rest}
  ...
  const rendered = childArr.map((child, i) =>
    isValidElement(child)
      ? cloneElement(child as React.ReactElement<any>, {
          key: i,
          ref: refs[i],
          style: { width, height, ...(((child as React.ReactElement<any>).props as any).style ?? {}) } as CSSProperties,
