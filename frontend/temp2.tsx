...
const features = [
  ...
  { title: "PII & Data Protection", desc: "Credit cards (Luhn), SSNs, IBANs, emails ÔÇö automated compliance evidence trails.", icon: "Ôèò" },
  { title: "Universal AI Trust ScoreÔäó", desc: "Real-time, dynamic risk quantification engine combining vulnerabilities, supply chain risk, and brand trust.", icon: "Ôÿà" },
  { title: "Real-Time Digital Twin", desc: "Interactive live attack graphs and zero-day threat prediction for your entire AI infrastructure.", icon: "ÔÜä" },
  { title: "Autonomous Red/Blue Agents", desc: "Continuous automated attack simulation and infrastructure-as-code patch generation.", icon: "ÔÜö" },
  { title: "AI Risk Scoring", desc: "IEEE-precise CVSS v3.1 base scores with 8-metric vector strings and CWE mappings.", icon: "R+" },
  { title: "Global Regulation Engine", desc: "One-click multi-framework compliance automation with automated evidence collection.", icon: "ÔÜû" },
  { title: "PDF Report Generation", desc: "HackerOne-style PDF security reports with executive summaries and full evidence.", icon: "Ôÿ░" },
];
...
const marqueeItems = [
  "Universal AI Trust ScoreÔäó", "Real-Time Organizational Digital Twin", "AI Attack Simulator", 
...
const faqItems = [
  ...
  { q: "Is there a free tier?", a: "Yes ÔÇö the Starter plan includes 5 scans/month with full access to all scan engines, completely free forever." },
...
/* ÔöÇÔöÇ Page ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */
export default function HomePage() {
  ...
  return (
    <main className="nubien-bg min-h-screen text-white overflow-hidden">
      {/* ÔöÇÔöÇ Header (initial + animate) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
      {/* ÔöÇÔöÇ Header (CardNav) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
      ...
      {/* ÔöÇÔöÇ Hero (parallax + scroll + spring) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="relative z-10 mx-auto max-w-4xl space-y-8 pt-10">
          <Reveal>
            <motion.div whileHover={{ hoverScale }} className="section-pill mx-auto cursor-default">
              <span>­ƒøí´©Å</span><span>AI Security V2.0 is now live</span>
            </motion.div>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            <p className="mx-auto max-w-2xl text-lg sm:text-xl text-gray-400 leading-relaxed">
              ...
              protect PII, and ensure regulatory compliance ÔÇö in real-time.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.3}>
            ...
            <p className="text-sm text-gray-600 mt-4">No credit card required ┬À Google SSO sign-in</p>
          </Reveal>
        </motion.div>
      ...
      {/* ÔöÇÔöÇ Features (stagger + variants + whileInView) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
      ...
      {/* ÔöÇÔöÇ Marquee (LogoLoop) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
      ...
      {/* ÔöÇÔöÇ How it Works (ScrollStack) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
      ...
      {/* ÔöÇÔöÇ Pricing (spring hover + layout) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
              ...
              <ul className="mt-6 space-y-3 text-sm text-gray-400 flex-1">
                {plan.items.map((d) => (
                  <motion.li key={d} className="flex items-center gap-2.5" whileHover={{ x: 4, color: "#e5e7eb" }} transition={{ type: "spring", stiffness: 500 }}>
                    <span className="text-violet-400 text-xs">Ô£ô</span><span>{d}</span>
                  </motion.li>
                ))}
              </ul>
      ...
      {/* ÔöÇÔöÇ FAQ (AnimatePresence + exit + layout) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
      ...
      {/* ÔöÇÔöÇ ScrollVelocity Transition ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
      ...
      {/* ÔöÇÔöÇ Footer ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ */}
      <Reveal>
        <footer className="mt-16 border-t border-white/[0.06] py-14">
          ...
          <div className="section-shell mt-10 flex flex-wrap items-center justify-between gap-3 border-t border-white/[0.06] pt-6 text-sm text-gray-600 relative z-10">
            ...
            <span>Made with ÔØñ´©Å for AI Safety</span>
          </div>
